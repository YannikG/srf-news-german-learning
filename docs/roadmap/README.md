...
**Status:** finalisiert (Review 2026-05-09). Änderungen an Phasen oder Issue-Specs nur bewusst und mit Anpassung der Abhängigkeiten.

| Dokument | Zweck |
|----------|--------|
| [overview.md](./overview.md) | Master-Reihenfolge aller Phasen und Phasen-Abhängigkeiten |
| [phase-1/README.md](./phase-1/README.md) … [phase-7](./phase-7/README.md) | Pro Phase: Endzustand, DoD, Issue-Liste, Issue-Graph |
